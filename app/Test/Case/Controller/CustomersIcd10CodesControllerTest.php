<?php
App::uses('CustomersIcd10CodesController', 'Controller');

/**
 * CustomersIcd10CodesController Test Case
 *
 */
class CustomersIcd10CodesControllerTest extends ControllerTestCase {
