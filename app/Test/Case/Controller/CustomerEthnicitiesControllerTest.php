<?php
App::uses('CustomerEthnicitiesController', 'Controller');

/**
 * CustomerEthnicitiesController Test Case
 *
 */
class CustomerEthnicitiesControllerTest extends ControllerTestCase {
