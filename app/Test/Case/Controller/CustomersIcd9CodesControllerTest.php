<?php
App::uses('CustomersIcd9CodesController', 'Controller');

/**
 * CustomersIcd9CodesController Test Case
 *
 */
class CustomersIcd9CodesControllerTest extends ControllerTestCase {
