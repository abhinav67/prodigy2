<?php
App::uses('DoctorSpecialitiesController', 'Controller');

/**
 * DoctorSpecialitiesController Test Case
 *
 */
class DoctorSpecialitiesControllerTest extends ControllerTestCase {
