<?php
App::uses('CustomerAttendancesController', 'Controller');

/**
 * CustomerAttendancesController Test Case
 *
 */
class CustomerAttendancesControllerTest extends ControllerTestCase {
