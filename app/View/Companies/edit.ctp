<div class="companies form">
	...
	<div class="row">
		...
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Customers'), array('controller' => 'Participants', 'action' => 'index'), array('escape' => false)); ?> </li>
							</ul>
						</div>
					</div>
				</div>			
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Company', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('state_id', array('placeholder' => 'State Id',"style"=>'width: 100%;'));?>
				</div>
				<div class="form-group">
				...
				<div class="form-group">Shift
					<?php echo $this->Form->input('am', array('class' => 'form-control','placeholder'=>'Shift','options'=>array(''=>'select shift','am'=>'Morning/Am shift'),'type'=>'select'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('pm', array('class' => 'form-control','placeholder'=>'Shift','options'=>array(''=>'select shift','pm'=>'Evening/Pm shift'),'type'=>'select'));?>
				</div>
				</div></div></div>
				<div class="form-group">
