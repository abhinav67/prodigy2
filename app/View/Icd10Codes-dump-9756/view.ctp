					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Icd10 Code'), array('action' => 'edit', $icd10Code['Icd10Code']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Icd10 Code'), array('action' => 'delete', $icd10Code['Icd10Code']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $icd10Code['Icd10Code']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Icd10 Codes'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Icd10 Code'), array('action' => 'add'), array('escape' => false)); ?> </li>
...
<tr>
		...
		<td>
			<?php echo h($icd10Code['Icd10Code']['code']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($icd10Code['Icd10Code']['desc']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		<th><?php echo __('Icd10 Codescol'); ?></th>
		<td>
			<?php echo h($icd10Code['Icd10Code']['icd10_codescol']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		<th><?php echo __('Icd10 Codescol1'); ?></th>
		<td>
			<?php echo h($icd10Code['Icd10Code']['icd10_codescol1']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		<th><?php echo __('Icd10 Codescol2'); ?></th>
		<td>
			<?php echo h($icd10Code['Icd10Code']['icd10_codescol2']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		<th><?php echo __('Icd10 Codescol3'); ?></th>
		<td>
			<?php echo h($icd10Code['Icd10Code']['icd10_codescol3']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		<th><?php echo __('Icd10 Codescol4'); ?></th>
		<td>
			<?php echo h($icd10Code['Icd10Code']['icd10_codescol4']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		<th><?php echo __('Icd10 Codescol5'); ?></th>
		<td>
			<?php echo h($icd10Code['Icd10Code']['icd10_codescol5']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		<th><?php echo __('Icd10 Codescol6'); ?></th>
		<td>
			<?php echo h($icd10Code['Icd10Code']['icd10_codescol6']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<?php if (!empty($icd10Code['Customer'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($icd10Code['Customer'] as $customer): ?>
		<tr>
