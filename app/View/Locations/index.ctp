					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Location'), array('action' => 'add'), array('escape' => false)); ?></li>
													</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($locations as $location): ?>
					<tr>
						...
						<td><?php echo h($location['Location']['parent_id']); ?>&nbsp;</td>
						<td><?php echo h($location['Location']['is_visible']); ?>&nbsp;</td>
						<td class="actions">
