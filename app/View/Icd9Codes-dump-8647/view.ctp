<div class="icd9Codes view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Icd9 Code'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Icd9 Code'), array('action' => 'edit', $icd9Code['Icd9Code']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Icd9 Code'), array('action' => 'delete', $icd9Code['Icd9Code']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $icd9Code['Icd9Code']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Icd9 Codes'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Icd9 Code'), array('action' => 'add'), array('escape' => false)); ?> </li>
		...
		<td>
			<?php echo h($icd9Code['Icd9Code']['id']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($icd9Code['Icd9Code']['code']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($icd9Code['Icd9Code']['long_desc']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($icd9Code['Icd9Code']['short_desc']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<?php if (!empty($icd9Code['Customer'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($icd9Code['Customer'] as $customer): ?>
		<tr>
