	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Authorizations Expiring Soon'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('auth_expiry',"Expiry Date"); ?></th>
				...
				<?php foreach ($customers as $customer): ?>
					<tr>
						...
						<td><?php echo h($customer['Customer']['auth_expiry']); ?>&nbsp;</td>
