<div class="customersIcd10Codes index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Customers Icd10 Codes'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Customers Icd10 Code'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('icd10_code_id'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($customersIcd10Codes as $customersIcd10Code): ?>
					<tr>
								<td>
			...
			<?php echo $this->Html->link($customersIcd10Code['Icd10Code']['id'], array('controller' => 'icd10_codes', 'action' => 'view', $customersIcd10Code['Icd10Code']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $customersIcd10Code['CustomersIcd10Code']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $customersIcd10Code['CustomersIcd10Code']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $customersIcd10Code['CustomersIcd10Code']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $customersIcd10Code['CustomersIcd10Code']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
