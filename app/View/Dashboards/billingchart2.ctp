...
foreach($wee as $ra){
$newdate= date('M-Y');
 $test[$i] = array($date[$ra],$avgg[$ra],$ssum[$ra],$exsum[$ra]);
...
google.setOnLoadCallback(drawChart);
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Date',' Billing Average','Actual Billing', 'Expected Billing'],
          <?php
        ...
        var options = {
          chart: {
            title: '2015 Billing Performance',
          ...
          <div class="panel-heading">Actions</div>
            <div class="panel-body">
              <ul class="nav nav-pills nav-stacked">
                <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;Weekly Billing'), array('action' => 'billingchart'), array('escape' => false)); ?></li>
