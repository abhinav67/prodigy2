	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>dashboards/dashboard_participants"><i class="glyphicon glyphicon-th-list"></i>Participants</a></li>              
...
<a href="<?php echo $wr;?>customers/add">
<div class="col-sm-6 col-lg-6">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-user dashicon" style="color:#222"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Participants</div>
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon" style="color:#2C9D25"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="dashtext">View Participants</div>
