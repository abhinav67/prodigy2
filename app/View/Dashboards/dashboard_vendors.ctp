	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>dashboards/dashboard_vendors"><i class="glyphicon glyphicon-th-list"></i>Vendors</a></li>
...
<a href="<?php echo $wr;?>VendorMasters/add">
<div class="col-sm-6 col-lg-6">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-share dashicon"style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Vendor</div>
...
<a href="<?php echo $wr;?>VendorMasters">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-check dashicon"style="color:#222"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Vendors</div>
...
<a href="<?php echo $wr;?>vendor_types/add">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-ok-circle dashicon"style="color:#2C9D25"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Vendor Type</div>
...
<a href="<?php echo $wr;?>vendor_types">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon"style="color:#8e8e8e"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Vendor Types</div>
