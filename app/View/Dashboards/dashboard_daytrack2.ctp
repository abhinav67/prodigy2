...
<hr>
    <div class="row"  style="margin-left:-10px;">
                ...
                <div class="col-md-12">
                    <a href="<?php echo $wr;?>dashboards/dashboard_daytrack2"><div class="col-md-2 daytrack-nav">Print Participant Sign-In Sheets</div></a>
                    <a href="<?php echo $wr;?>dashboards/dashboard_daytrack1"><div class="col-md-2 daytrack-nav" style="margin-left:20%;">Print Driver Schedules</div></a>
 ...
 <div class="row text-center">
      <div class="col-md-12">
        <div class="col-md-4"><h4><b> Date </b></h4></div>
        <div class="col-md-4"><h4><b> Insurance </b></h4></div>
        <div class="col-md-4"><h4><b> Shift </b></h4></div>
        
          
      </div>
    </div>
               <div class="col-md-12">
            <form method="get" action="<?php echo $this->webroot;?>dashboards/print_participants/?>" >
    <div class="col-md-4">
    
      <div class="form-group">
      <input type="text" name="datedaytrack" required=required class='form-control' id='datedaytrack' class="form-control" placeholder="Select Date">
      ...
      <select name="insure" required=required class='form-control' id='insure'>
        <option disabled selected>Select Insurance</option>
        <?php

foreach($itypes as $itype)
    {
    echo "<option>". $itype ."</option>\n";    
}
...
<div class="form-group">
    <input type="submit" value="Submit" class="btn btn-default" style="
    margin-left: 31px"></div>
    </form>
