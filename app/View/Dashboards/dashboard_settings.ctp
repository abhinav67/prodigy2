	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>dashboards/dashboard_settings"><i class="glyphicon glyphicon-th-list"></i>Settings</a></li>  
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-briefcase dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Company Information</div>
                            </div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon" style="color:#222"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Insurances</div>
                            </div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-usd dashicon" style="color:#2C9D25"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Charges</div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-user dashicon" style="color:#8e8e8e"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Users</div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-globe dashicon" style="color:#215C96"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">User Groups</div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-plus-sign dashicon" style="color:red"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Doctors</div>
...
<a href="<?php echo $wr;?>status_codes">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-sort-by-alphabet dashicon" style="color:#8e44ad"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Status Codes</div>
...
<a href="<?php echo $wr;?>water_locations">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-map-marker dashicon" style="color:#2980b9"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Water Locations</div>
