	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>dashboards/dashboard_employee"><i class="glyphicon glyphicon-th-list"></i>Employees</a></li>
...
<a href="<?php echo $wr;?>employees/add">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-user dashicon" style="color:maroon"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="dashtext">Add Employee</div>
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon" style="color:#2C9D25"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="dashtext">View Employees</div>
...
<a href="<?php echo $wr;?>vacation_calenders/add">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-calendar dashicon" style="color:#222"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Vacation Calender</div>
...
<a href="<?php echo $wr;?>vacation_calenders">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-tasks dashicon"style="color:#8e8e8e"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="dashtext">View Vacation Calender</div>
