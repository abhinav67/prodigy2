	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>dashboards/dashboard_attendance"><i class="glyphicon glyphicon-th-list"></i>Attendance and Billing</a></li>
...
<a href="<?php echo $wr;?>customer_attendances/recent_attendance/?shift=am">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-saved dashicon" style="color:maroon"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="dashtext">Mark Today's Attendance</div>
...
<a href="<?php echo $wr;?>customer_attendances/selectday">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-time dashicon" style="color:#222"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Mark Custom Attendance</div>
...
<a href="<?php echo $wr;?>customer_attendances">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon" style="color:#2C9D25"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Attendance</div>
...
<a href="<?php echo $wr;?>billings/today_billing">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-print dashicon" style="color:#8e8e8e"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Today's Billing</div>
...
<!--Edited by DINESH-->
<!--<a href="<?php echo $wr;?>billings/cutomers.ctp">-->
<a href="<?php echo $wr;?>Billings/customers">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-wrench dashicon" style="color:#215C96"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Custom Billing</div>
...
<a href="<?php echo $wr;?>billing_records">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon style="color:red""></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Billing Records</div>
