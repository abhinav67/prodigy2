	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>dashboards/dashboard_transport"><i class="glyphicon glyphicon-th-list"></i>Transport</a></li>
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-map-marker dashicon" style="color:maroon"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="dashtext">Add Routes</div>
                            </div>
...
<a href="<?php echo $wr;?>DriverLogs/add">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-upload dashicon" style="color:#222"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Driver Logs</div>
                            </div>
...
<a href="<?php echo $wr;?>vehicles/add">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-road dashicon" style="color:#2C9D25"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Vehicle Fleet Details</div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-tasks dashicon" style="color:#8e8e8e"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Routes</div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon" style="color:#215C96"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Driver Logs</div>
...
<div class="col-sm-4 col-lg-4">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-globe dashicon" style="color:red"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Vehicle Fleets</div>
