	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>dashboards/dashboard_others"><i class="glyphicon glyphicon-th-list"></i>Others</a></li>
...
<h3 style="margin-top: 14px;">Others</h3>
...
<a href="<?php echo $wr;?>primary_diets/add">
<div class="col-sm-6 col-lg-6">
                ...
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-cutlery dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Primary Diet</div>
...
<a href="<?php echo $wr;?>primary_diets">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-tasks dashicon" style="color:#2C9D25"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Primary Diets</div>
...
<a href="<?php echo $wr;?>QualityReports/add">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-floppy-disk dashicon" style="color:#222"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Add Incident Report</div>
...
<a href="<?php echo $wr;?>QualityReports">
<div class="col-sm-6 col-lg-6">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-list-alt dashicon" style="color:#6e6e6e"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">View Incident Reports</div>
