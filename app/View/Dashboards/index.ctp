<!-- Start of test96313 Zendesk Widget script -->
<script>/*<![CDATA[*/window.zEmbed||function(e,t){var n,o,d,i,s,a=[],r=document.createElement("iframe");window.zEmbed=function(){a.push(arguments)},window.zE=window.zE||window.zEmbed,r.src="javascript:false",r.title="",r.role="presentation",(r.frameElement||r).style.cssText="display: none",d=document.getElementsByTagName("script"),d=d[d.length-1],d.parentNode.insertBefore(r,d),i=r.contentWindow,s=i.document;try{o=s}catch(c){n=document.domain,r.src='javascript:var d=document.open();d.domain="'+n+'";void(0);',o=s}o.open()._l=function(){var o=this.createElement("script");n&&(this.domain=n),o.id="js-iframe-async",o.src=e,this.t=+new Date,this.zendeskHost=t,this.zEQueue=a,this.body.appendChild(o)},o.write('<body onload="document._l();">'),o.close()}("//assets.zendesk.com/embeddable_framework/main.js","test96313.zendesk.com");/*]]>*/</script>
<!-- End of test96313 Zendesk Widget script -->
	...
	<div class="col-lg-3 col-md-3">
      <!-- Left column -->
         ...
         <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="<?php echo $wr;?>"><i class="glyphicon glyphicon-th-list"></i>Dashboard</a></li>
     ...
     <div id="datepicker"  style="padding-top: 15px;margin-top: 25px;"></div></div>
                                        </div>
<hr>
...
<h3 style="margin-top: 14px;">Dashboards</h3>

</div>
<hr>
<div class="row">
  <br>
  <a href="<?php echo $wr;?>dashboards/participant_enrollment">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">

                  <div class="glyphicon glyphicon-list-alt dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Participant Enrollment</div>
...
<a href="<?php echo $wr;?>dashboards/chart1">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-time dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Attendance</div>
...
<a href="<?php echo $wr;?>dashboards/billingchart">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-print dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Billing</div>
...
<a href="<?php echo $wr;?>dashboards/routes">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-map-marker dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Routes</div>
...
<a href="<?php echo $wr;?>activities/activities">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-saved dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Activities</div>
...
<a href="<?php echo $wr;?>employees/employees">
<div class="col-sm-4 col-lg-4">
                        <center>
                                  <div class="panel panel-primary" style="    border-color: #f2f2f2;">
                    <div class="panel-heading dashbox selected" style="background-color: #f2f2f2;    border-color: #f2f2f2; border-width:medium;">
                <div class="row">
                  ...
                  <div class="glyphicon glyphicon-user dashicon" style="color:maroon"></div>
                </div>
                        <div class="row">

                                <div class="dashtext">Employees</div>
                ...
                <!--<br>
                <h4><a href="http://localhost/prodigysmartflow3/dashboards/participant_enrollment">Participant Enrollment</a></h4>
                <h4><a href="http://localhost/prodigysmartflow3/dashboards/activities">Activities</a></h4>
                <h4><a href="http://localhost/prodigysmartflow3/dashboards/employees">Employees</a></h4>-->
</div>
