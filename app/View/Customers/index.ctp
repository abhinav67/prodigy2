...
<?php include 'rsv.php'; ?>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<button type="button" class="btn btn-link" onclick="printFunction()">Print this page</button>
...
<thead>
				...
				<?php foreach ($customers as $customer): ?>
					<tr>
						...
						<td><?php echo h($customer['Customer']['date_of_birth']); ?>&nbsp;</td>

						<td><?php echo h($customer['Customer']['address']); ?>&nbsp;</td>
						<!--<td><?php echo h($customer['Customer']['city']); ?>&nbsp;</td>-->
						<td><?php echo h($customer['City']['name']); ?>&nbsp;</td>
