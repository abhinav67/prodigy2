	...
	<div class="row">
		<div class="col-lg-12 col-sm-12">
			<div class="page-header">
				<h1><?php echo __('Add New Participants'); ?></h1>
 ...
 -->      </h4>
	...
	<div class="form-group col-lg-12">
			...
			<div class="col-lg-6 col-sm-6">  <!-- 2nd column -->
				...
				<div class="form-group col-lg-6">
					<?php echo $this->Form->input('city_id', array('selected'=>'Choose One','class'=>'',
					'placeholder'=> 'City Id', "style"=>'width: 100%'));?>
				</div>
				<div class="form-group col-lg-6">
				...
				<div class="form-group col-lg-6">
					<?php
					 ...
					 echo $this->Form->input('birth_state', array('type'=>'select', 
					 'placeholder' => 'birth_country', 'label' => 'Birth State',"style"=>'width: 100%;'));?>
				</div>							
		...
		<div class="row"> <!-- 2nd main row -->
			<div class="col-lg-6 col-sm-6"> <!-- 1st column -->
				...
				<!--<div class="form-group col-lg-12"  id="">
					...
					//if(isset($_SESSION['legacy']) && $_SESSION['legacy']==1)
					{
					//echo $this->Form->input('icd9_codes_id', array('selected'=>'Choose One','class'=>'',
					//'placeholder'=> 'icd9_codes_id', "style"=>'width: 100%'));
					}
					//else if(isset($_SESSION['legacy']) && $_SESSION['legacy']==0)
					{
					//echo $this->Form->input('icd10_codes_id', array('selected'=>'Choose One','class'=>'',
					//'placeholder'=> 'icd10_codes_id', "style"=>'width: 100%'));
					}
					?>
				</div>-->
      ...
      <div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-lg-6 col-sm-6">	<!-- 2nd column -->
				...
				<div class="form-group">
					<?php echo $this->Form->input('application_date', array('type'=>'text',"data-date-format"=>"mm-dd-yyyy",'class' => 'form-control', 'placeholder' => 'Application Date'));?>
				</div>
				<div class="form-group">
