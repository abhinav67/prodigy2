	...
	<div class="row">
		<div class="col-lg-12 col-sm-12">
			<div class="page-header">
				<h1><?php echo __('Clone New Participants'); ?></h1>
 ...
 -->      </h4>
	...
	<div class="form-group col-lg-12">
			...
			<div class="col-lg-6 col-sm-6">  <!-- 2nd column -->
				...
				<div class="form-group col-lg-6">
					<?php $editstate="";
					if(!empty($customer['LocationCountry']))
					{
					$editstate=$customer['LocationCountry']['id'];
				
					}echo $this->Form->input('birth_country', array('type'=>'select','options'=>$locationCountry,'class' => '', 'placeholder' => 'birth_state', 'label' => 'Birth Country',"style"=>'width: 100%;'));?>
				</div>
			<div class="form-group col-lg-6">
					<?php
