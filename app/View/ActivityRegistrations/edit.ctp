<div class="activityRegistrations form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Edit Activity Registration'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete'), array('action' => 'delete', $this->Form->value('ActivityRegistration.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('ActivityRegistration.id'))); ?></li>
																<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Activity Registrations'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-4">
			<?php echo $this->Form->create('ActivityRegistration', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('date_of_registration', array('type'=>'text','class' => 'form-control',"data-date-format"=>"mm-dd-yyyy", 'placeholder' => 'Date Of Registration'));?>
				</div>
				<div class="form-group">
